    ...
    render() {
        return(
            ...
            <div className="container">
                <div className="row justify-content-between mb-4">
                    <div className="col-md-3">
                        <div className="logo_footer">
                            <div className="mb-3">
                                <a href="true">
                                    <img src="images/logo-footer.svg" alt="logoFooter"  />
                                </a>
                            </div>
                    ...
                    <div className="col-md-3">
                        <div className="social_media">
                            <ul className="social_links d-flex justify-content-between mb-4">
                                <li><a href>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="5.857" height="12.69"
                                ...
                                <li><a href>
                                        <svg id="instagram_1" data-name="instagram 1" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div className="app_stores">
                                ...
                                <div className="stores d-flex align-items-start">
                                    ...
                                    <a href="#">
                                        <span className="d-flex align-items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="13.124" height="16"
                                                viewBox="0 0 13.124 16">
                                                <g id="apple_2_1" data-name="apple (2) 1"
                                                    ...
                                                    <g id="Group">
                                                        <path id="Vector"
                                                            ...
                                                            transform="translate(1163.438 4564.686)" fill="#fff" />
                                                        <path id="Vector-2" data-name="Vector"
                                                            d="M3.006,0A3.152,3.152,0,0,1,.024,3.511,3.39,3.39,0,0,1,3.006,0Z"
                                                            transform="translate(1169.974 4561)" fill="#fff" />
                                                    </g>
                                                </g>
                                            </svg>
                ...
                <div className="row rights text-center">
